    ...
    <div class="dashboard-container py-4">
        ...
        <div class="header-section">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1 class="display-6 fw-bold mb-3"><i class="bi bi-calendar-plus me-3"></i>Tambah Data Absensi</h1>
                    <p class="lead mb-0">Isi form berikut untuk menambahkan data absensi baru</p>
                </div>
        ...
        <div class="main-card">
            ...
            <div class="card-header-custom">
                <h5 class="card-title mb-0 fw-bold text-dark">
                    <i class="bi bi-clipboard-check me-2"></i>Form Data Absensi
                </h5>
            </div>
                ...
                <form action="{{ route('attendances.store') }}" method="POST">
                    ...
                    <div class="form-group-custom">
                        ...
                        <select name="status" 
                            ...
                            <option value="tidak_hadir" {{ old('status') == 'tidak_hadir' ? 'selected' : '' }}>Tanpa Keterangan</option>
                        </select>
                        @error('status')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
