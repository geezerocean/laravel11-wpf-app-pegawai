...
<body>
    <div class="dashboard-container py-4">
        ...
        <div class="header-section">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1 class="display-6 fw-bold mb-3"><i class="bi bi-calendar-check me-3"></i>Edit Data Absensi</h1>
                    <p class="lead mb-0">Perbarui informasi data absensi</p>
                </div>
        ...
        <div class="main-card">
                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h5 class="card-title mb-0 fw-bold text-dark">
                            <i class="bi bi-clipboard-check me-2"></i>Form Edit Data Absensi
                        </h5>
                    </div>
                    <div class="col-md-4 text-end">
                        <span class="attendance-info-badge">
            ...
            <div class="form-section">
                <form action="{{ route('attendances.update', $attendance->id) }}" method="POST">
                    ...
                    <div class="form-group-custom">
                        <label for="tanggal" class="form-label-custom required-field">
                    ...
                    <div class="form-group-custom">
                        <label for="status" class="form-label-custom required-field">
                            <i class="bi bi-clipboard-check"></i>Status Kehadiran
                        </label>
                        <select name="status" 
                                id="status" 
                                class="form-select form-select-custom" 
                            ...
                            <option value="tidak_hadir" {{ old('status', $attendance->status) == 'tidak_hadir' ? 'selected' : '' }}>Tanpa Keterangan</option>
                        </select>
                        @error('status')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group-custom">
                                <label for="waktu_masuk" class="form-label-custom">
                                    <i class="bi bi-clock"></i>Waktu Masuk
                                </label>
                                ...
                                <div class="form-help-text">Kosongkan jika tidak hadir</div>
                                @error('waktu_masuk')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group-custom">
                                <label for="waktu_keluar" class="form-label-custom">
                                    <i class="bi bi-clock"></i>Waktu Keluar
                                </label>
                                <div class="time-input-group">
                                    <input type="time" 
                                           name="waktu_keluar" 
                    ...
                    <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                        ...
                        <button type="submit" class="btn btn-warning-custom">
                            <i class="bi bi-check-circle me-2"></i>Perbarui Absensi
                        </button>
                    </div>
                </form>
            </div>
    ...
    <script>
        // Auto-disable waktu jika status bukan hadir
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function toggleTimeInputs() {
                if (statusSelect.value !== 'hadir') {
                    ...
                    if (statusSelect.value !== '{{ $attendance->status }}') {
                        waktuMasuk.value = '';
                        waktuKeluar.value = '';
                    }
                } else {
