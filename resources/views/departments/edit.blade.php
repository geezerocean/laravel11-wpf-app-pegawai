    ...
    <div class="dashboard-container py-4">
        ...
        <div class="header-section">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1 class="display-6 fw-bold mb-3"><i class="bi bi-building-gear me-3"></i>Edit Data Departemen</h1>
                    <p class="lead mb-0">Perbarui informasi data departemen</p>
                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h5 class="card-title mb-0 fw-bold text-dark">
                            <i class="bi bi-building me-2"></i>Form Edit Data Departemen
                        </h5>
                    </div>
                    <div class="col-md-4 text-end">
                ...
                <form action="{{ route('departments.update', $department->id) }}" method="POST">
                        ...
                        <div class="col-md-6">
                            <div class="form-group-custom">
                                ...
                                <input type="number" 
                                       name="jumlah_pegawai" 
                                       class="form-control form-control-custom" 
                                       value="{{ old('jumlah_pegawai', $department->jumlah_pegawai) }}"
                    ...
                    <div class="form-group-custom">
                        ...
                        <textarea name="deskripsi" 
                                  class="form-control form-control-custom" 
                                  rows="3" 
                                  placeholder="Masukkan deskripsi departemen">{{ old('deskripsi', $department->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                        ...
                        <button type="submit" class="btn btn-primary-custom">
                            <i class="bi bi-check-circle me-2"></i>Perbarui Departemen
                        </button>
                    </div>
                </form>
            </div>
