    ...
    <div class="dashboard-container py-4">
        ...
        <div class="header-section">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1 class="display-6 fw-bold mb-3"><i class="bi bi-person-gear me-3"></i>Edit Data Karyawan</h1>
                    <p class="lead mb-0">Perbarui informasi data karyawan</p>
                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h5 class="card-title mb-0 fw-bold text-dark">
                            <i class="bi bi-person-badge me-2"></i>Form Edit Data Karyawan
                        </h5>
                    </div>
                    <div class="col-md-4 text-end">
                            ...
                            <div class="col-md-6">
                                <div class="form-group-custom">
                                    ...
                                    <input type="date" 
                                           ...
                                           value="{{ old('tanggal_bergabung', $employee->tanggal_bergabung) }}"
                                           required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group-custom">
                                    ...
                                    <input type="date" 
                                           class="form-control form-control-custom" 
                                           name="tanggal_keluar" 
                                           value="{{ old('tanggal_keluar', $employee->tanggal_keluar) }}">
