    ...
    <div class="dashboard-container py-4">
        ...
        <div class="header-section">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1 class="display-6 fw-bold mb-3"><i class="bi bi-person-badge-add me-3"></i>Tambah Jabatan Baru</h1>
                    <p class="lead mb-0">Isi form berikut untuk menambahkan jabatan baru</p>
                </div>
        ...
        <div class="main-card">
            ...
            <div class="card-header-custom">
                <h5 class="card-title mb-0 fw-bold text-dark">
                    <i class="bi bi-person-badge me-2"></i>Form Data Jabatan
                </h5>
            </div>
                ...
                <form action="{{ route('positions.store') }}" method="POST">
                    ...
                    <div class="form-group-custom">
                        ...
                        <select name="level_jabatan" 
                            ...
                            <option value="Junior" {{ old('level_jabatan') == 'Junior' ? 'selected' : '' }}>Junior</option>
                            <option value="Mid" {{ old('level_jabatan') == 'Mid' ? 'selected' : '' }}>Mid</option>
                            <option value="Senior" {{ old('level_jabatan') == 'Senior' ? 'selected' : '' }}>Senior</option>
                    ...
                    <div class="form-group-custom">
                        ...
                        <textarea name="deskripsi_pekerjaan" 
                                  ...
                                  class="form-control form-control-custom" 
                                  rows="4" 
                                  placeholder="Masukkan deskripsi pekerjaan untuk jabatan ini">{{ old('deskripsi_pekerjaan') }}</textarea>
                    ...
                    <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                        ...
                        <button type="submit" class="btn btn-success-custom">
                            <i class="bi bi-check-circle me-2"></i>Simpan Jabatan
                        </button>
                    </div>
                </form>
            </div>
